...
export const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/pending-recipes', label: 'Pending Recipes', icon: Clock },
    { path: '/admin/categories', label: 'Categories', icon: List },
    { path: '/admin/ingredients', label: 'Ingredients', icon: Package },
    { path: '/admin/ingredient-requests', label: 'Ingredient Requests', icon: PlusCircle },
    { path: '/admin/report-comments', label: 'Reported Comments', icon: MessageSquareWarning },
    { path: '/admin/report-recipes', label: 'Reported Recipes', icon: Utensils },
    { path: '/admin/report-users', label: 'Reported Users', icon: UserX },
  ];
        ...
        <div className="p-6 border-b border-slate-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">RecipeShare</p>
            </div>
          </div>
        </div>
