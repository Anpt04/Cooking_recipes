...
export const FollowersList = () => {
  ...
  useEffect(() => {
    followAPI.getFollowers(Number(id)).then((res) => {
              ...
              {followers.map((u: any, i: number) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">@{u.follower.username}</p>
                  </div>
                </Link>
              ))}
            </div>
